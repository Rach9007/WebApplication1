...
namespace WebApplication1.Controllers
{
    ...
    public class PraticiensController : Controller
    {
        ...
        public PraticiensController(GSB_Gestion_AppContext context)
        {
            _context = context;
        }
        ...
        {
            var gSB_Gestion_AppContext = _context.Praticiens.Include(p => p.TypCodeNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(short id)
        {
            ...
            {
                return Problem("Entity set 'GSB_Gestion_AppContext.Praticiens'  is null.");
            }
            var praticien = await _context.Praticiens.FindAsync(id);
            if (praticien != null)
            {
