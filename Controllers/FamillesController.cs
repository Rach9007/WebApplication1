...
namespace WebApplication1.Controllers
{
    public class FamillesController : Controller
    {
        ...
        public FamillesController(GSB_Gestion_AppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Familles != null ? 
                          ...
                          Problem("Entity set 'GSB_Gestion_AppContext.Familles'  is null.");
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var famille = await _context.Familles.Include(m=>m.Medicaments) //jointure avec médicaments
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'GSB_Gestion_AppContext.Familles'  is null.");
            }
            var famille = await _context.Familles.FindAsync(id);
            if (famille != null)
            {
